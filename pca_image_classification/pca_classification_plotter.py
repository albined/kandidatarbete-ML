...
def plot_results():
    ...
    testing_accuracy = pd.read_csv(
        os.path.join(tools.get_project_root(), 'pca_image_classification', 'results', f'accuracy.csv'), sep=';',
        index_col=0)
    testing_time = pd.read_csv(
        os.path.join(tools.get_project_root(), 'pca_image_classification', 'results', f'testing_time.csv'), sep=';',
        index_col=0)
    training_time = pd.read_csv(
        os.path.join(tools.get_project_root(), 'pca_image_classification', 'results', f'training_time.csv'), sep=';',
        index_col=0)
